...
1. **Add authentication to `.env.local`**:
   ```env
   QUARTZ_COOKIES="your-cookie-string-here"
   ```
...
1. Ensure you're logged into Quartz in your browser
2. Get fresh cookies from DevTools
3. Update `QUARTZ_COOKIES` in `.env.local`
...
- Verify `.env.local` exists and contains `QUARTZ_COOKIES`
